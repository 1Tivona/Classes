...
class Car extends Factory{
  constructor(model, doors, color, enginetype, transmission, trim, wheelstrim, audio, seatstrim, moonroof, warranty, enginesize, navigation, backupcamera){
    super(warranty);
    this.enginesize = 4;
...
class Truck extends Factory{
  constructor(warranty, model, color, enginesize, hitch, bed, navigation, backupcamera, audio){
    super(warranty);
    this.backupcamera = true;
    this.audio = "basic";
